...
jQuery(document).ready(function($) {
    ...
    if (typeof window.wp_sms_voipms === 'undefined') {
        ...
        $('#contacts-table-body').html('<tr><td colspan="5">Erreur: Variables JavaScript manquantes</td></tr>');
        return;
    }
    ...
    function loadContacts(searchTerm) {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                $('#contacts-table-body').html('<tr><td colspan="5">Erreur lors du chargement des contacts: ' + xhr.status + '</td></tr>');
            }
        });
    }
